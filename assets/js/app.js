...
document.addEventListener("touchmove", navbolean);
    ...
    $(function (){
        ...
        $(".menu .menu-accueil a, .menu .menu-news a, .menu .menu-classement a, .menu .menu-contact a, .nav-mobile .menu-accueil a, .nav-mobile .menu-news a, .nav-mobile .menu-classement a, .nav-mobile .menu-contact a").on("click", function(event){
